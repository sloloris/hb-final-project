...
#     #write a query to get oauth_token and oauth_expiry out of table for given user_id
#     #if oauth_token and oauth_expiry < now, post? and send to account page
#     #else get new credentials
#     user_credentials = oauth2client.client.Credentials.new_from_json(user_id)
...
#     return "Credentials stored for user {}".format(user_id)
